...
class ModelTrainer:
    ...
    def _train_epoch(self):
        ...
        return running_loss / len(self.train_loader), acc, f1
    ...
    def _val_epoch(self):
        ...
        acc, f1, _ = self.metrics.compute()
        return running_loss / len(self.val_loader), acc, f1
    ...
    def _step_scheduler(self, v_loss: float, v_f1: float):
        if self.scheduler is None:
            return
        # ReduceLROnPlateau требует метрику на вход
    ...
    def fit(
        ...
        for epoch in range(1, epochs + 1):
            ...
            t_loss, t_acc, t_f1 = self._train_epoch()
